...
logging.basicConfig(filename=os.path.join(log_dir, 'prediction.log'),
                    level=logging.INFO,
...
if __name__ == "__main__":
    ...
    with Live("results/", save_dvc_exp=True) as live:
        live.log_metric("features", ", ".join(model.feature_names_in_))
        live.log_metric("path_to_results", f"{RESULTS_PATH}/{run_timestamp}_rf_model_results.csv")
